...
export default function ServicesAdmin() {
    ...
    return (
        <div>
            ...
            <div className="min-h-full rounded-2xl border border-gray-200 bg-white px-5 py-7 dark:border-gray-800 dark:bg-white/3 xl:px-10 xl:py-12">
                ...
                <div className="max-w-7xl mx-auto min-h-full flex flex-col">
                    <div className="flex flex-wrap flex-1 gap-6 overflow-hidden">
                        ...
                        <div className="w-64  rounded-lg border border-gray-200 p-4 sm:flex flex-col h-full hidden">
                            <Label className="text-sm font-semibold uppercase tracking-wider mb-4">Categorías</Label>
                        ...
                        {/* LISTA DE SERVICIOS */}
                        <div className="flex-1 rounded-lg border border-gray-200 p-6 overflow-y-auto relative bg-gray-50/50 dark:bg-gray-800/5">
                            {activeCategory && (
                                <>
                                    <div className="flex items-center justify-between mb-6">
                                        <Label className="text-xl font-bold text-gray-800">Servicios: {activeCategory.name}</Label>
                                        {/* Opción para editar la categoría activa desde el título */}
                                        <Button variant="outline" onClick={(e) => handleEditCategoryClick(e, activeCategory)} className="text-gray-400 hover:text-blue-600 sm:hidden cursor-pointer">
                                            <Pencil size={18} />
                                        </Button>
                                    </div>
                                    ...
                                    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
                                        {services.filter(service => service.categoryId === activeCategory.id).map(service => (
                                            <div
                                                ...
                                                className="white p-4 rounded-xl shadow-sm border border-gray-200 hover:shadow-md hover:border-blue-300 transition-all cursor-pointer group"
                                            >
                                                <div className="flex justify-between items-start mb-2">
                                                    <Label className="font-semibold text-gray-900 group-hover:text-blue-600 transition-colors">
                                                        {service.name}
                                                    </Label>
                                                </div>
                                                ...
                                                <div className="flex justify-between items-center text-sm mt-4 pt-3 border-t border-gray-100">
                                                    <div className="flex items-center text-gray-900 font-bold">
                                                        <DollarSign size={18} className="mr-0.5 text-gray-400" />
                                                        <Label color="dark:text-brand-400">{service.price}</Label>
                                                    </div>
                                                    <div className="flex items-center  align-middle text-gray-500">
                                                        <Clock size={18} className="mr-1" />
                                                        <Label color="dark:text-brand-400">{service.duration} min</Label>
                                                    </div>
                                                </div>
                                            </div>
                                        ))}
            ...
            >
                {/* HEADER */}
                <div className="flex-none px-6 py-4 border-b border-gray-200 dark:border-gray-800  dark:bg-gray-900 flex justify-between items-center">
                    <div>
